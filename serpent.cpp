...
// 128 Bit:   Key Setup: 1289/1294 cycles
// Encrypt:   759 cycles = 33.7 mbits/sec
// Decrypt:   775 cycles = 33.0 mbits/sec
// 192 Bit:   Key Setup: 1293/1295 cycles
// Encrypt:   761 cycles = 33.6 mbits/sec
// Decrypt:   772 cycles = 33.1 mbits/sec
...
// Processor: PII (200 MHz)
// Algorithm: serpent 
// Encapsulated Key Schedule (C++)
// 128 Bit:   Key Setup: 1358/1363 cycles
// Encrypt:   771 cycles = 33.2 mbits/sec
// Decrypt:   769 cycles = 33.2 mbits/sec
// 192 Bit:   Key Setup: 1352/1367 cycles
// Encrypt:   768 cycles = 33.3 mbits/sec
// Decrypt:   765 cycles = 33.4 mbits/sec
// 256 Bit:   Key Setup: 1343/1358 cycles
// Encrypt:   764 cycles = 33.5 mbits/sec
// Decrypt:   770 cycles = 33.2 mbits/sec
...
void SERPENT(set_key(const u1byte in_key[], const u4byte key_len))
{
...
#else
    __asm   lea esi,SERPENT(l_key) + 4*8
#endif
...
#else
    __asm   lea esi,SERPENT(l_key) + 4*140
#endif
